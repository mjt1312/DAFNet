...
output_path = '../data/imagenet_refine.pkl'



seq_home = '/home/zhuyabin/my-dataset/ILSVRC/'
train_list = [p for p in os.listdir(seq_home + 'Data/VID/')]
seq_list = []
for num, cur_dir in enumerate(train_list):
    seq_list += [cur_dir + '/' + p for p in os.listdir(seq_home + 'Data/VID/' + cur_dir)]
...
for i,seqname in enumerate(seq_list):
    print(seqname)
    seq_path = seq_home + 'Data/VID/' + seqname
    gt_path = seq_home +'Annotations/VID/' + seqname
